    ...
    run: async(client, message, args) => {
        ...
        if (language === "pt-BR") { // PT-BR
            ...
            if (!args[0] || args[0] !== "yes" && args[0] !== "cancel") {
                ...
                .setColor("WHITE")
                .setFooter('Alerta!:  Isso pode apagar as configurações do servidor! Não afeta com comandos de economia!')
        ...
        if (!language || language === "en") { // EN
            ...
            if (!args[0] || args[0] !== "yes" && args[0] !== "cancel") {
                ...
                .setColor("WHITE")
                .setFooter('Alert!: This may erase server settings! Does not affect with economy commands!')
                message.reply({ embeds: [embed] });
            }
