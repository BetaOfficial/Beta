...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (language === "pt-BR") { // PT-BR
            ...
            if(!member || !role) {
                let embed = new Discord.MessageEmbed()
                .setDescription(`**${config.emoji.no} Você precisa me dizer um cargo e um usuário válido! Use: \`${prefix}removerole <usuário> <cargo>\`**`)
                .setColor("WHITE")
                return message.reply({ embeds: [embed] });
            }
            ...
            try {
                ...
                .setDescription(`${config.emoji.yes} **Removi o cargo pedido em um usuário! Veja as informações abaixo:**`)
                ...
                .setDescription(`${config.emoji.no} **Hey! Não consegui remover o cargo ${role} de ${member}!**`)
                .setColor("WHITE")
        ...
        if (!language || language === "en") { // EN
            ...
            if(!member || !role) {
                let embed = new Discord.MessageEmbed()
                .setDescription(`**${config.emoji.no} You need to tell me a title and a valid username! Use: \`${prefix}removerole <username> <role>\`**`)
                .setColor("WHITE")
                return message.reply({ embeds: [embed] });
            }
            ...
            try {
                ...
                let embed_complete = new Discord.MessageEmbed()
                .setDescription(`${config.emoji.yes} **I removed the requested role in a user! See the information below:**`)
                .addField(`**👮‍♂️ MOD:**`, `**${message.author}**\n**\`${message.author.id}\`**`, false)
                ...
                let embed_error = new Discord.MessageEmbed()
                .setDescription(`${config.emoji.no} **Hey! I couldn't remove the role ${role} from ${member}!**`)
                .setColor("WHITE")
                return message.reply({ embeds: [embed_error] });
            }
        }
