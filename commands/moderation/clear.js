    ...
    run: async (client, message, args) => {
        ...
        if (language === "pt-BR") { // PT-BR
            ...
            try {
                ...
                .setColor("WHITE")
                .setDescription(`> **${message.author} o valor máximo é de 200 mensagens!**`)

                if (parseInt(delamount) > 200) return message.reply({ embeds: [valmáx] }).then(m => {
                    setTimeout(() => {
                        m.delete()
                    }, 15000) // 15 segundos
                })
        ...
        if (!language || language === "en") { // EN
            ...
            try {
                ...
                const valmáx = new Discord.MessageEmbed()
                .setColor("WHITE")
                .setDescription(`> **${message.author} the maximum value is 200 messages!**`)
