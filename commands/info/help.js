                ...
                message.reply({ content: `${message.author}`, embeds: [embed_home], components: [painel] }).then(msg => {
                    ...
                    const filter = (interaction) => {
                        if(interaction.user.id == message.author.id) return true; 
                            ...
                            interaction.reply({ content: `**${e.no} Apenas ${message.author} pode usar esse painel! Caso queira usar o menu de ajuda use:**\n**\`${prefix}help\`**!`, ephemeral: true })
                        }
                    }
                ...
                message.reply({ content: `${message.author}`, embeds: [embed_home], components: [painel] }).then(msg => {
                    ...
                    const filter = (interaction) => {
                        if(interaction.user.id == message.author.id) return true; 
                            ...
                            interaction.reply({ content: `**${e.no} Only ${message.author} you can use this panel! If you want to use the help menu use:**\n**\`${prefix}help\`**!`, ephemeral: true })
                        }
                    }
